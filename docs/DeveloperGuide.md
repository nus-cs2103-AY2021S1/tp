...
* [**`Model`**](#model-component): Holds the data of the App in memory. Comprises of an `InventoryModel` and a `DeliveryModel` which handles `Item` and `Delivery` respectively.
