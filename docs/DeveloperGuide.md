...
## Appendix : Detailed sequence diagrams for features
...
![AddIngredientSequence](images/feature/ingredient/AddIngredientSequence.png)
...
The following sequence diagram shows how delete consumption operation works when `execute("deleteC 1")` API call:

![DeleteConsumptionSequence](images/feature/consumption/DeleteConsumptionSequence.png)
...
![SearchRecipeSequence](images/feature/recipe/SearchRecipeSequence.png)
