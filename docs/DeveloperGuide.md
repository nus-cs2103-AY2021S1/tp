...
The target audience of this guide is for anyone who wishes to extend or modify the functionality of ZooKeepBook. The guide is split into 3 sections, covering the [design of ZooKeepBook](#3-design), the [implementation of certain features](#4-implementation) as well as how to [manage the development of ZooKeepBook](#5-documentation-logging-testing-configuration-dev-ops).
