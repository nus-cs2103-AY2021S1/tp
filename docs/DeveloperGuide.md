...
This document details the architecture and software design of the software CliniCal, which is implemented as part of our CS2103T project. This document is updated as the design and implementation of the software is modified after every milestone. Each milestone will include a version of this document, and the current milestone of this project is `v1.3`.
