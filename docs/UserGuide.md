...
<br> Insert the information of the specified recipe to the edit into the command box for editing purposes.
...
<br> Adds the information of the specified ingredient to the edit command into the command box for editing purposes.
