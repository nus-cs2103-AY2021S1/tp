...
**Create new teammate** | `newteammate (mn/TEAMMATE_NAME) (mg/GIT_USERNAME) (mp/PHONE_NUMBER) (me/EMAIL) (ma/ADDRESS)` eg, `newteammate mn/Lucas mg/LucasTai98 mp/93824823 me/lucas@gmail.com ma/18 Evelyn Road`| project scope
**Add a teammate to a project** | `addtoproject GIT_USERNAME` eg, `addtoproject LucasTai98` | project scope
**Remove a teammate from a project** |`deletefromproject GIT_USERNAME` eg, `deletefromproject LucasTai98` | project scope
...
**View a teammate’s details** | `viewteammate GIT_USERNAME` | project scope
**Delete a teammate** | `deleteteammate GIT_USERNAME` | project scope
