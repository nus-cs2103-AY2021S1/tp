...
1) To set reminders for assignments "Essay" and "Assignment 3" (the second and fourth assignment respectively in your Assignment List as shown in Figure 17), you can simply enter `remind 2 4` into the [Command Box](#gui-terminologies).
