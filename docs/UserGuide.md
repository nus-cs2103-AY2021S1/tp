...
* The search finds cases depending on which section they are in. If they are in the DEFAULT section, cases found are in DEFAULT section only.
 ...
 and can alternate between sections using [`list case`](#list-all-default-investigation-cases-list-case) or [`list archive`](#list-all-archived-investigation-cases-list-archive)
