...
- [4. Features](#4-features)
  ...
  * [4.2 Day commands](#42-day-commands)
    + [4.2.1 Adding a daily weight record](#421-adding-a-daily-weight-record--add-ddate-wweight)
    + [4.2.2 Editing a daily weight record ](#422-editing-a-daily-weight-record--edit-index-wweight)
  ...
  * [4.6 Additional Features for BMT Commanders](#46-additional-features-for-bmt-commanders)
    + [4.6.1 View overall BMI progress of the recruits](#461-view-overall-bmi-progress-of-the-recruits-stats-vcommander)
