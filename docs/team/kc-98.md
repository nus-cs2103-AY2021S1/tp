...
* **Testing**:
  ...
  * Created unit tests for other classes that include (Pull request: [#180](https://github.com/AY2021S1-CS2103T-T15-3/tp/pull/180)):
    * StockBookParser
    * ModelManager
    * StockBook
    * UserPrefs
  ...
  * Created utility classes for `testutil` that include (Pull request: [#180](https://github.com/AY2021S1-CS2103T-T15-3/tp/pull/180)):
...
* **Documentation**:
  * User Guide:
    ...
    * Updated the documentation for `delete` feature. (Pull request: [#103](https://github.com/AY2021S1-CS2103T-T15-3/tp/pull/103))
    * Updated the documentation for `stats` feature. (Pull request: [#146](https://github.com/AY2021S1-CS2103T-T15-3/tp/pull/146))
  ...
  * Developer Guide:
    * Updated NFR and Appendix section for Warenager. (Pull request: [#54](https://github.com/AY2021S1-CS2103T-T15-3/tp/pull/54))
