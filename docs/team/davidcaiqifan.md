...
* **New Feature**: Added features that allows the user to calculate relevant CAP details.
  ...
  * Justification: This feature fits the purpose of the application very well because the application is academic focused. The user most likely will want to be able to calculate his/her academic details. <div style="page-break-after: always;"></div>  
