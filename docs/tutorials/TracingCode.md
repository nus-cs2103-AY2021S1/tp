...
> Indeed, the ratio of meetingDate spent reading versus writing is well over 10 to 1. We are constantly reading old code as part of the effort to write new code. …​\[Therefore,\] making it easy to read makes it easier to write.
>
...
2.  What components will you have to modify to perform the following
    ...
    2.  Allow `delete` to remove more than one index at a meetingDate
