...
public class AddCommand extends Command {
    ...
    void setParameters(Parameter<String> nameParameter, OptionalParameter<Protein> proteinParameter,
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        Food toAdd = new Food(nameParameter.consume(), newProtein, newFat, newCarb);
