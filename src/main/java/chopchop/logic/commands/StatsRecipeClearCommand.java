...
public class StatsRecipeClearCommand extends Command implements Undoable {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD + " : deletes all saved"
        + "records of recipe usage from ChopChop. It can be undone but cannot be restored.";
    ...
    public CommandResult undo(Model model) throws CommandException {
        ...
        return CommandResult.message("Undo: restored records of recipes made" + this.usages.getUsageCount());
    }
}
