 ...
 */
public class LoadAttendanceCommandParser implements Parser<LoadAttendanceCommand> {
     ...
     */
    @Override
    public LoadAttendanceCommand parse(String args) throws ParseException {
        ...
        return new LoadAttendanceCommand(filename);
    }
}
