...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path commonCentsFilePath = Paths.get("data" , "CommonCents.json");
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setCommonCentsFilePath(newUserPrefs.getCommonCentsFilePath());
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && commonCentsFilePath.equals(o.commonCentsFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, commonCentsFilePath);
    }
