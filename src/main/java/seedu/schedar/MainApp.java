...
import seedu.schedar.commons.core.Version;
import seedu.schedar.commons.exceptions.DataConversionException;
import seedu.schedar.commons.util.ConfigUtil;
import seedu.schedar.commons.util.StringUtil;
import seedu.schedar.logic.Logic;
import seedu.schedar.logic.LogicManager;
...
import seedu.schedar.storage.TaskManagerStorage;
import seedu.schedar.storage.UserPrefsStorage;
import seedu.schedar.ui.Ui;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        ...
        TaskManagerStorage addressBookStorage = new JsonTaskManagerStorage(userPrefs.getTaskManagerFilePath());
    ...
    /**
     * Returns a {@code ModelManager} with the data from {@code storage}'s task manager and {@code userPrefs}. <br>
     * The data from the sample task manager will be used instead if {@code storage}'s task manager is not found,
     * or an empty task manager will be used instead if errors occur when reading {@code storage}'s task manager.
     */
