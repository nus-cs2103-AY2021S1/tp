...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String BRIEF_COMMAND_EXPLANATION = "The list of commands that tCheck can recognize are"
            + " as follows:\n"
            + "c-add n/NAME p/PHONE_NUMBER e/EMERGENCY_CONTACT a/ADDRESS [t/TAG] ...: Adds a person to the contact "
            + "list.\n"
            ...
            + "i-set-default: Sets all ingredients' levels to a standard default amount.\n"
