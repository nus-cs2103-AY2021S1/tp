...
public class HelpWindow extends UiPart<Stage> {
    ...
    public static final String BRIEF_COMMAND_EXPLANATION = "The list of commands that tCheck can recognize are"
            ...
            + "c-tomorrow: Shows a list of all employees whose tags contain tomorrow's day (i.e. Wednesday, Tuesday, etc).\n"
            + "c-edit INDEX [n/NAME] [e/EMERGENCY_CONTACT] [a/ADDRESS] [t/TAG]…: Edits the corresponding contact information in"
            + " the contact list.\n"
            ...
            + "current day.\n"
            + "s-find KEYWORD [MORE_KEYWORDS]: Finds all drinks where its abbreviated name matches words in "
            + "KEYWORD(s).\n"
