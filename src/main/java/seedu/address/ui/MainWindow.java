...
public class MainWindow extends UiPart<Stage> {
    ...
    void fillInnerParts() {
        ...
        StatusBarFooter statusBarFooter = new StatusBarFooter(logic.getPlanusFilePath());
     ...
     */
    private CommandResult executeCommand(String commandText) throws CommandException, ParseException, MultipleAttributesException {
        try {
        ...
        } catch (CommandException | ParseException | MultipleAttributesException e) {
