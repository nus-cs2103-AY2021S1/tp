...
public class ColorPicker {
    ...
    public static final Color WHITE_BORDER = Color.rgb(213, 215, 215);

    public static final Color TURQUOISE_DARK = Color.rgb(0, 147, 123);
    public static final Color ORANGE_DARK = Color.rgb(166, 126, 65);
    public static final Color RED_DARK = Color.rgb(160, 78, 116);
    public static final Color WHITE_DARK = Color.rgb(167, 168, 168);
    public static final Color TURQUOISE_BORDER_DARK = Color.rgb(21, 120, 103);
