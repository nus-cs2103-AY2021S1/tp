    ...
    public EditCommand parse(String args) throws ParseException {
        ...
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_NRIC, PREFIX_PHONE,
                        PREFIX_EMAIL, PREFIX_ADDRESS, PREFIX_TAG, PREFIX_MEDICAL_RECORD);
        ...
        if (argMultimap.getValue(PREFIX_MEDICAL_RECORD).isPresent()) {
            editPersonDescriptor.setMedicalRecord(ParserUtil.parseMedicalRecord(
                    argMultimap.getValue(PREFIX_MEDICAL_RECORD).get()));
        }
        parseTagsForEdit(argMultimap.getAllValues(PREFIX_TAG)).ifPresent(editPersonDescriptor::setAllergies);
