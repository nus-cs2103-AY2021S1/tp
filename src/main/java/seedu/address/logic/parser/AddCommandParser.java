...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        TagName tagName = ParserUtil.parseName(argMultimap.getValue(PREFIX_NAME).get());
        FileAddress fileAddress = ParserUtil.parseAddress(argMultimap.getValue(PREFIX_ADDRESS).get());
