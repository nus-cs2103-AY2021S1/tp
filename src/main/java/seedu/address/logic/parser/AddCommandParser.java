...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_PROJECT_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        Project project = new Project(projectName, phone, email, address, tagList, new HashMap<>(), taskList);
