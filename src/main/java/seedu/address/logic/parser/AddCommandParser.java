...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        Set<ClientSource> clientSourceList = ParserUtil.parseClientSources(argMultimap.getAllValues(PREFIX_CLIENTSOURCE));

        Person person = new Person(name, phone, email, address, clientSourceList);
