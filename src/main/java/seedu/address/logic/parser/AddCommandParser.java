...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ArgumentMultimap argMultimap =
                ArgumentTokenizer.tokenize(args, PREFIX_NAME, PREFIX_PHONE, PREFIX_REPOURL,
                        PREFIX_ADDRESS, PREFIX_TAG, PREFIX_TASK);

        if (!arePrefixesPresent(argMultimap, PREFIX_NAME, PREFIX_ADDRESS, PREFIX_PHONE, PREFIX_REPOURL)
        ...
        Project project = new Project(name, phone, repoUrl, address, tagList, new HashMap<>(), taskList);
