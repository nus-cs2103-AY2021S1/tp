...
public class AddCommandParser implements Parser<AddCommand> {
    ...
    public AddCommand parse(String args) throws ParseException {
        ...
        if (!arePrefixesPresent(argMultimap, PREFIX_PROJECT_NAME, PREFIX_PROJECT_DESCRIPTION, PREFIX_PHONE, PREFIX_EMAIL)
        ...
        ProjectDescription projectDescription = ParserUtil.projectDescription(argMultimap.getValue(PREFIX_PROJECT_DESCRIPTION).get());
        Set<Tag> tagList = ParserUtil.parseTags(argMultimap.getAllValues(PREFIX_TAG));
        Set<Task> taskList = ParserUtil.parseTasks(argMultimap.getAllValues(PREFIX_TASK));

        Project project = new Project(projectName, phone, email, projectDescription, tagList, new HashMap<>(), taskList);
