...
/**
 * Edits the details of an existing student in the current tutorial group.
 */
public class EditStudentCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            + ": Edits the details of the student identified by the index number used in the displayed"
            + " student list. Existing values will be overwritten by the input values.\n"
    ...
    public static class EditStudentDescriptor {
        ...
        public boolean isAnyFieldEdited() {
            return CollectionUtil.isAnyNonNull(name, phone, email, tags, studentId);
        }
