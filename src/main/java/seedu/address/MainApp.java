...
import seedu.address.storage.StockBookStorage;
...
public class MainApp extends Application {
     ...
     * The data from the sample address book will be used instead if {@code storage}'s stock book is not found,
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            initialData = StockBookOptional.orElseGet(SampleDataUtil::getSampleAddressBook);
