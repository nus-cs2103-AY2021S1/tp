...
import seedu.address.storage.WishfulShrinkingStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing WishfulShrinking ]===========================");
        super.init();
        ...
        WishfulShrinkingStorage addressBookStorage = new JsonWishfulShrinkingStorage(userPrefs.getWishfulShrinkingFilePath());
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty WishfulShrinking");
            initialData = new WishfulShrinking();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting WishfulShrinking " + MainApp.VERSION);
