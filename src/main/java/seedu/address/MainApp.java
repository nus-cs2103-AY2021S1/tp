...
import seedu.address.storage.MainCatalogueStorage;
...
public class MainApp extends Application {
    ...
    public void init() throws Exception {
        logger.info("=============================[ Initializing MainCatalogue ]===========================");
        super.init();
    ...
    private Model initModelManager(Storage storage, ReadOnlyUserPrefs userPrefs) {
        ...
        try {
            ...
            logger.warning("Problem while reading from the file. Will be starting with an empty MainCatalogue");
            initialData = new MainCatalogue();
        }
    ...
    public void start(Stage primaryStage) {
        logger.info("Starting MainCatalogue " + MainApp.VERSION);
