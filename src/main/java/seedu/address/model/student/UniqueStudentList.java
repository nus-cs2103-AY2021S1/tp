 ...
 * of students uses Student#isSameStudent(Student) for equality so as to ensure that the student being added or updated
 * is unique in terms of identity in the UniqueStudentList. However, the removal of a student uses
