...
public interface Model {
     ...
     * The patient must exist in Hospify.
     */
    void deletePatient(Patient target);

    /**
     * Adds the given patient.
     * {@code patient} must not already exist in Hospify.
     */
     ...
     * The person identity of {@code editedPatient} must not be the same as another existing patient in Hospify.
     */
