...
public class SampleDataUtil {
    public static Project[] getSampleProjects() {
        return new Project[] {
            new Project(new ProjectName("Alex Yeoh"), new Phone("87438807"), new Email("alexyeoh@example.com"),
                new ProjectDescription("Blk 30 Geylang Street 29, #06-40"),
                getTagSet("friends"), new HashMap<>(), getTaskSet("Refactor project class")),
            new Project(new ProjectName("Bernice Yu"), new Phone("99272758"), new Email("berniceyu@example.com"),
            ...
            new Project(new ProjectName("Charlotte Oliveiro"), new Phone("93210283"),
                ...
                new ProjectDescription("Blk 11 Ang Mo Kio Street 74, #11-04"),
            ...
            new Project(new ProjectName("Irfan Ibrahim"), new Phone("92492021"), new Email("irfan@example.com"),
                new ProjectDescription("Blk 47 Tampines Street 20, #17-35"),
                getTagSet("classmates"), new HashMap<>(), getTaskSet()),
            new Project(new ProjectName("Roy Balakrishnan"), new Phone("92624417"), new Email("royb@example.com"),
                new ProjectDescription("Blk 45 Aljunied Street 85, #11-31"),
