...
public class SampleDataUtil {
    public static Project[] getSampleProjects() {
        return new Project[] {
            ...
            new Project(new Name("Charlotte Oliveiro"), new Leader("93210283"), new ProjectDescription("charlotte@example.com"),
            ...
            new Project(new Name("Roy Balakrishnan"), new Leader("92624417"), new ProjectDescription("royb@example.com"),
