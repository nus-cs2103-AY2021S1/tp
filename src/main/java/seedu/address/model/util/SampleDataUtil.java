...
public class SampleDataUtil {
    ...
    public static Recipe[] getSampleRecipes() {
        ...
        return new Recipe[] {
            new Recipe(0, ingredients, 2, "Fruit basket", new ProductQuantity("1"), "Recipe 1")
        };
    }
