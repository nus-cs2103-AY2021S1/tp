    ...
    public static Student[] getSamplePersons() {
        ...
        return new Student[]{
            new Student(new Name("Alex Yeoh"), new Phone("87438807"),
                        ...
                        getAttendance(new Attendance("14/04/1998", "attended",
            ...
            new Student(new Name("Bernice Yu"), new Phone("99272758"),
                        ...
                        getAttendance(new Attendance("06/05/2010", "unattended",
            ...
            new Student(new Name("Charlotte Oliveiro"), new Phone("93210283"),
                        ...
                        getAttendance(new Attendance("01/01/2020", "attended",
            ...
            new Student(new Name("David Li"), new Phone("91031282"),
                        ...
                        getAttendance(new Attendance("26/10/2020", "unattended",
            ...
            new Student(new Name("Irfan Ibrahim"), new Phone("92492021"),
                        ...
                        getAttendance(new Attendance("25/12/2020", "attended",
