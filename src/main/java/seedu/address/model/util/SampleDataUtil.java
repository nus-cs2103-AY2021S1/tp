...
public class SampleDataUtil {
    ...
    public static Person[] getSamplePersons() {
        return new Person[] {
            new Person(new Name("Alex Yeoh"), sampleDescription,
            ...
            new Person(new Name("Bernice Yu"), sampleDescription,
            ...
            new Person(new Name("Charlotte Oliveiro"), sampleDescription,
            ...
            new Person(new Name("David Li"), sampleDescription, new Email("lidavid@example.com"),
                    Status.createStatus("active"), sampleDocuments,
                    new Address("Blk 436 Serangoon Gardens Street 26, #16-43"),
                    new ArrayList<>(), sampleVictims, sampleWitnesses, getTagSet("family")),
            new Person(new Name("Irfan Ibrahim"), sampleDescription,
            ...
            new Person(new Name("Roy Balakrishnan"), sampleDescription,
