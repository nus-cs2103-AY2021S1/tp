...
class JsonAdaptedPerson {
    ...
    /**
     * Constructs a {@code JsonAdaptedPerson} with the given log details.
     */
    @JsonCreator
     ...
     */
    public JsonAdaptedPerson(Log source) {
    ...
    public Log toModelType() throws IllegalValueException {
        ...
        return new Log(modelName, modelPhone, modelEmail, modelAddress, modelTags);
    }
