...
public class JsonContactListStorage implements ContactListStorage {
    ...
    public void saveContactList(ReadOnlyContactList contactList, Path filePath) throws IOException {
        requireAllNonNull(contactList, filePath);
        FileUtil.createIfMissing(filePath);
        JsonSerializableContactList contactListJsonFile = new JsonSerializableContactList(contactList);
        JsonUtil.saveJsonFile(contactListJsonFile, filePath);
    }
