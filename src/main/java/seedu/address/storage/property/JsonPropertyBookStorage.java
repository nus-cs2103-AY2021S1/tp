...
public class JsonPropertyBookStorage implements PropertyBookStorage {
    ...
    @Override
    public void savePropertyBook(ReadOnlyPropertyBook addressBook) throws IOException {
        savePropertyBook(addressBook, filePath);
    }
     ...
     */
    public void savePropertyBook(ReadOnlyPropertyBook addressBook, Path filePath) throws IOException {
        requireNonNull(addressBook);
        requireNonNull(filePath);

        FileUtil.createIfMissing(filePath);
        JsonUtil.saveJsonFile(new JsonSerializablePropertyBook(addressBook), filePath);
    }
