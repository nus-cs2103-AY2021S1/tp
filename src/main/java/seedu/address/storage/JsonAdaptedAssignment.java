...
class JsonAdaptedAssignment {
     ...
     */
    @JsonCreator
    public JsonAdaptedAssignment(@JsonProperty("name") String name, @JsonProperty("phone") String phone,
    ...
    public Assignment toModelType() throws IllegalValueException {
        ...
        return new Assignment(modelName, modelPhone, modelEmail, modelAddress, modelTags);
    }
