...
public class UserPrefs implements ReadOnlyUserPrefs {
    ...
    private Path logBookFilePath = Paths.get("data" , "logbook.json");
    ...
    public void resetData(ReadOnlyUserPrefs newUserPrefs) {
        ...
        setLogBookFilePath(newUserPrefs.getLogBookFilePath());
    }
    ...
    public boolean equals(Object other) {
        ...
        return guiSettings.equals(o.guiSettings)
                && logBookFilePath.equals(o.logBookFilePath);
    }

    @Override
    public int hashCode() {
        return Objects.hash(guiSettings, logBookFilePath);
    }
