...
public class Email {
    ...
    public static final String MESSAGE_CONSTRAINTS = "Emails should be of the format local-part@domain.top-level-domain "
            + "and adhere to the following constraints:\n"
            + "1. The local-part should only contain alphanumeric characters and these special characters, excluding "
            + "the parentheses, (" + SPECIAL_CHARACTERS + ") . The local part should not start with a '.'. \n"
            + "2. This is followed by a '@' and then a domain name and then followed by a top-level domain name. "
    ...
    public static final String VALIDATION_REGEX_CHECK = "(?:[a-z0-9!#$%&'*+/=?^_`{|}~-]+(?:\\."
    ...
    public static boolean isValidEmail(String test) {
        ...
        return trimmedTest.isBlank() || trimmedTest.matches(VALIDATION_REGEX_CHECK);
    }
