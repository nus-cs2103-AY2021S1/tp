...
import static com.eva.testutil.TypicalIndexes.INDEX_THIRD_PERSON;
...
public class EditStaffCommandParserTest {
    ...
    public void parse_missingParts_failure() {
        ...
        assertParseFailure(parser, "", String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditStaffCommand.MESSAGE_USAGE));
    }
