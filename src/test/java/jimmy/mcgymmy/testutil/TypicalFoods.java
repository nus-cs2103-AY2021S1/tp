...
public class TypicalFoods {
    ...
    public static final Food FRUIT_CAKE = new FoodBuilder().withName(new Name("Fruit Cake"))
            .withProtein("927").withFat("987").withCarb("789")
            .withDate("3 Feb 1998").build();
    public static final Food GINGERBREAD = new FoodBuilder().withName(new Name("Gingerbread"))
            .withProtein("942").withFat("789").withCarb("987")
            .withDate("5 May 1973").build();

    // Manually added
    public static final Food HOT_PLATE = new FoodBuilder().withName(new Name("Hot Plate")).withProtein("824")
            .withFat("123").withCarb("123").withDate("5 May 1973").build();
    public static final Food INDOMEE = new FoodBuilder().withName(new Name("Indomee")).withProtein("831")
            .withFat("123").withCarb("123").withDate("5 May 1973").build();
