...
public class JsonSerializableLogBookTest {
    ...
    public void toModelType_typicalPersonsFile_success() throws Exception {
        JsonSerializableLogBook dataFromFile = JsonUtil.readJsonFile(TYPICAL_PERSONS_FILE,
                JsonSerializableLogBook.class).get();
        AddressBook addressBookFromFile = dataFromFile.toModelType();
        AddressBook typicalPersonsAddressBook = TypicalLogs.getTypicalLogBook();
        assertEquals(addressBookFromFile, typicalPersonsAddressBook);
    }

    @Test
    public void toModelType_invalidPersonFile_throwsIllegalValueException() throws Exception {
        JsonSerializableLogBook dataFromFile = JsonUtil.readJsonFile(INVALID_PERSON_FILE,
                JsonSerializableLogBook.class).get();
    ...
    public void toModelType_duplicatePersons_throwsIllegalValueException() throws Exception {
        JsonSerializableLogBook dataFromFile = JsonUtil.readJsonFile(DUPLICATE_PERSON_FILE,
                JsonSerializableLogBook.class).get();
        assertThrows(IllegalValueException.class, JsonSerializableLogBook.MESSAGE_DUPLICATE_PERSON,
