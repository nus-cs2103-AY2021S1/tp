...
import static seedu.fma.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    private static final String INVALID_NAME = "6G&6a&S^g7v";
    private static final String INVALID_TAG = "#friend";

    private static final String VALID_NAME = "Sit ups";
    ...
    public void parseIndex_validInput_success() throws Exception {
        // No whitespaces
        assertEquals(INDEX_FIRST_LOG, ParserUtil.parseIndex("1"));
