...
public class DeleteCategoryCommandParserTest {
    ...
    public void parse_validTagFieldPresent_success() {
        ...
        assertParseSuccess(parser, TAG_DESC_FOOD, new DeleteCategoryCommand(expectedTag));
    }

    @Test
    public void parse_tagFieldMissing_failure() {
        String expectedMessage = String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteCategoryCommand.MESSAGE_USAGE);
