...
import seedu.address.storage.sellerstorage.JsonSerializableSellerAddressBook;
import seedu.address.testutil.seller.TypicalSeller;

public class JsonSerializableSellerAddressBookTest {

    private static final Path TEST_DATA_FOLDER = Paths.get("src", "test",
            "data", "JsonSerializableSellerAddressBookTest");
    private static final Path TYPICAL_SELLERS_FILE = TEST_DATA_FOLDER.resolve("typicalSellersAddressBook.json");
    ...
    public void toModelType_typicalSellersFile_success() throws Exception {
        JsonSerializableSellerAddressBook dataFromFile = JsonUtil.readJsonFile(TYPICAL_SELLERS_FILE,
                JsonSerializableSellerAddressBook.class).get();
        SellerAddressBook addressBookFromFile = dataFromFile.toModelType();
        SellerAddressBook typicalSellerAddressBook = TypicalSeller.getTypicalSellerAddressBook();
        //assertEquals(addressBookFromFile, typicalSellerAddressBook);
    }
    ...
    @Test
    public void toModelType_duplicateSellers_throwsIllegalValueException() throws Exception {
