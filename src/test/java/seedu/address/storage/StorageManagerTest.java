...
public class StorageManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonBugListStorage addressBookStorage = new JsonBugListStorage(getTempFilePath("ab"));
    ...
    public void addressBookReadSave() throws Exception {
        /*
         * Note: This is an integration test that verifies the StorageManager is properly wired to the
         * {@link JsonBugListStorage} class.
         * More extensive testing of UserPref saving/reading is done in {@link JsonBugListStorageTest} class.
         */
