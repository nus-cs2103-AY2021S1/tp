...
//    private static final List<JsonAdaptedAttendance> VALID_ATTENDANCE = new ArrayList<>().addAll();
//    private static final String VALID_PARTICIPATION = BENG.getAttendance().getParticipationScoreAsString();
//
//    @Test
