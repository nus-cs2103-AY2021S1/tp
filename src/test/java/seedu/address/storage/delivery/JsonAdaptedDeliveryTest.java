...
public class JsonAdaptedDeliveryTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery =
                new JsonAdaptedDelivery(INVALID_NAME, VALID_PHONE, VALID_ADDRESS, VALID_ORDER);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery = new JsonAdaptedDelivery(null, VALID_PHONE, VALID_ADDRESS, VALID_ADDRESS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery =
                new JsonAdaptedDelivery(VALID_NAME, INVALID_PHONE, VALID_ADDRESS, VALID_ADDRESS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery = new JsonAdaptedDelivery(VALID_NAME, null, VALID_ADDRESS, VALID_ADDRESS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery =
                new JsonAdaptedDelivery(VALID_NAME, VALID_PHONE, INVALID_ADDRESS, VALID_ADDRESS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery = new JsonAdaptedDelivery(VALID_NAME, VALID_PHONE, null, VALID_ADDRESS);
    ...
    public void toModelType_invalidOrder_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery =
                new JsonAdaptedDelivery(VALID_NAME, VALID_PHONE, VALID_ADDRESS, INVALID_ORDER);
    ...
    public void toModelType_nullOrder_throwsIllegalValueException() {
        JsonAdaptedDelivery delivery = new JsonAdaptedDelivery(VALID_NAME, VALID_PHONE, VALID_ADDRESS, null);
