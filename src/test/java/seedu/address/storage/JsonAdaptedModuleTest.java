...
public class JsonAdaptedModuleTest {
    ...
    public void toModelType_invalidModuleCode_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(INVALID_MODULE_CODE, VALID_MODULE_NAME, VALID_PERSONS);
    ...
    public void toModelType_nullModuleCode_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(null, VALID_MODULE_NAME, VALID_PERSONS);
    ...
    public void toModelType_invalidModuleName_throwsIllegalValueException() {
        JsonAdaptedModule module =
                new JsonAdaptedModule(VALID_MODULE_CODE, INVALID_MODULE_NAME, VALID_PERSONS);
    ...
    public void toModelType_nullModuleName_throwsIllegalValueException() {
        JsonAdaptedModule module = new JsonAdaptedModule(VALID_MODULE_CODE, null, VALID_PERSONS);
