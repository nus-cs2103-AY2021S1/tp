...
public class JsonAdaptedCaseTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(INVALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedCase person = new JsonAdaptedCase(null, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL,
                VALID_STATUS,
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, INVALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_nullDescription_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, null, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, INVALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedCase person = new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, null, VALID_EMAIL,
                VALID_STATUS,
                VALID_DOCUMENTS, VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_invalidEmail_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, INVALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_nullEmail_throwsIllegalValueException() {
        JsonAdaptedCase person = new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, null,
                VALID_STATUS,
                VALID_DOCUMENTS, VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_invalidStatus_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, INVALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_nullStatus_throwsIllegalValueException() {
        JsonAdaptedCase person = new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE,
                VALID_EMAIL, null,
                VALID_DOCUMENTS, VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        INVALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedCase person = new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL,
                VALID_STATUS,
                VALID_DOCUMENTS, null, VALID_SUSPECTS, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS, VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS,
    ...
    public void toModelType_invalidSuspect_throwsIllegalValueException() {
        ...
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, invalidSuspects, VALID_VICTIMS, VALID_WITNESSES, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidVictims_throwsIllegalValueException() {
        ...
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, invalidVictims, VALID_WITNESSES, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
    ...
    public void toModelType_invalidWitnesses_throwsIllegalValueException() {
        ...
        JsonAdaptedCase person =
                new JsonAdaptedCase(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_STATUS,
                        VALID_DOCUMENTS,
                        VALID_ADDRESS, VALID_SUSPECTS, VALID_VICTIMS, invalidWitnesses, VALID_TAGS);
        assertThrows(IllegalValueException.class, person::toModelType);
    }
