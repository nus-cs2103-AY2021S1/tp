...
public class JsonAdaptedExerciseTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(INVALID_NAME, VALID_DESCRIPTION,
                                                VALID_DATE, VALID_CALORIES, VALID_MUSCLES);
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, INVALID_DESCRIPTION, VALID_DATE, VALID_CALORIES, VALID_MUSCLES);
    ...
    public void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedExercise exercise =
                new JsonAdaptedExercise(VALID_NAME, VALID_DESCRIPTION, INVALID_DATE, VALID_CALORIES, VALID_MUSCLES);
    ...
    public void toModelType_nullDate_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(VALID_NAME, VALID_DESCRIPTION,
                                        null, VALID_CALORIES, VALID_MUSCLES);
    ...
    public void toModelType_invalidCalories_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(VALID_NAME, VALID_DESCRIPTION,
                VALID_DATE, INVALID_CALORIES, VALID_MUSCLES);
    ...
    public void toModelType_invalidMuscles_throwsIllegalValueException() {
        JsonAdaptedExercise exercise = new JsonAdaptedExercise(VALID_NAME, VALID_DESCRIPTION,
                VALID_DATE, VALID_CALORIES, INVALID_MUSCLES);
