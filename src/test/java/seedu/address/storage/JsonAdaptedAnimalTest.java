...
public class JsonAdaptedAnimalTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedAnimal animal =
                new JsonAdaptedAnimal(INVALID_NAME, VALID_ID, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedAnimal animal = new JsonAdaptedAnimal(null, VALID_ID, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_invalidId_throwsIllegalValueException() {
        JsonAdaptedAnimal animal =
                new JsonAdaptedAnimal(VALID_NAME, INVALID_ID, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullId_throwsIllegalValueException() {
        JsonAdaptedAnimal animal = new JsonAdaptedAnimal(VALID_NAME, null, VALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_invalidSpecies_throwsIllegalValueException() {
        JsonAdaptedAnimal animal =
                new JsonAdaptedAnimal(VALID_NAME, VALID_ID, INVALID_SPECIES, VALID_TAGS);
    ...
    public void toModelType_nullSpecies_throwsIllegalValueException() {
        JsonAdaptedAnimal animal = new JsonAdaptedAnimal(VALID_NAME, VALID_ID, null, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedAnimal animal =
                new JsonAdaptedAnimal(VALID_NAME, VALID_ID, VALID_SPECIES, invalidTags);
