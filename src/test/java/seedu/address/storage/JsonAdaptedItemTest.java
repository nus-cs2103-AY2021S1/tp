...
public class JsonAdaptedItemTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedItem item =
                new JsonAdaptedItem(INVALID_NAME, VALID_QUANTITY, VALID_SUPPLIER, VALID_TAGS, VALID_MAX_QUANTITY);
    ...
    public void toModelType_invalidQuantity_throwsIllegalValueException() {
        JsonAdaptedItem item =
                new JsonAdaptedItem(VALID_NAME, INVALID_QUANTITY, VALID_SUPPLIER, VALID_TAGS, VALID_MAX_QUANTITY);
    ...
    public void toModelType_nullQuantity_throwsIllegalValueException() {
        JsonAdaptedItem item = new JsonAdaptedItem(VALID_NAME, null, VALID_SUPPLIER, VALID_TAGS, VALID_MAX_QUANTITY);
    ...
    public void toModelType_invalidSupplier_throwsIllegalValueException() {
        JsonAdaptedItem item =
                new JsonAdaptedItem(VALID_NAME, VALID_QUANTITY, INVALID_SUPPLIER, VALID_TAGS, VALID_MAX_QUANTITY);
    ...
    public void toModelType_nullSupplier_throwsIllegalValueException() {
        JsonAdaptedItem item = new JsonAdaptedItem(VALID_NAME, VALID_QUANTITY, null, VALID_TAGS, VALID_MAX_QUANTITY);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedItem item =
                new JsonAdaptedItem(VALID_NAME, VALID_QUANTITY, VALID_SUPPLIER, invalidTags, VALID_MAX_QUANTITY);
    ...
    public void toModelType_invalidMaxQuantity_throwsIllegalValueException() {
        JsonAdaptedItem item = new JsonAdaptedItem(VALID_NAME, VALID_QUANTITY,
                VALID_SUPPLIER, VALID_TAGS, INVALID_MAX_QUANTITY);
        String expectedMessage = Quantity.MESSAGE_CONSTRAINTS;
        assertThrows(IllegalValueException.class, expectedMessage, item::toModelType);
    }
