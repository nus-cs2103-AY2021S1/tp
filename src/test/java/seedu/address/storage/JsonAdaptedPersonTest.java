...
public class JsonAdaptedPersonTest {
    ...
    public void toModelType_nullName_throwsIllegalValueException() {
        JsonAdaptedPerson person = new JsonAdaptedPerson(null, VALID_DESCRIPTION, VALID_PHONE,
    ...
    public void toModelType_invalidDescription_throwsIllegalValueException() {
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, INVALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
                        VALID_SUSPECTS, VALID_VICTIMS, VALID_TAGS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL, VALID_ADDRESS,
    ...
    public void toModelType_invalidVictims_throwsIllegalValueException() {
        ...
        JsonAdaptedPerson person =
                new JsonAdaptedPerson(VALID_NAME, VALID_DESCRIPTION, VALID_PHONE, VALID_EMAIL,
                        VALID_ADDRESS, VALID_SUSPECTS,
