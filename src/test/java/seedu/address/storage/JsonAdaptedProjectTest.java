...
public class JsonAdaptedProjectTest {
    ...
    public void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(INVALID_NAME, VALID_PHONE, VALID_REPOURL, VALID_ADDRESS,
    ...
    public void toModelType_invalidPhone_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_NAME, INVALID_PHONE, VALID_REPOURL, VALID_ADDRESS,
                        VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_nullPhone_throwsIllegalValueException() {
        JsonAdaptedProject project = new JsonAdaptedProject(VALID_NAME, null, VALID_REPOURL, VALID_ADDRESS,
                VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_invalidRepoUrl_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_NAME, VALID_PHONE, INVALID_REPOURL, VALID_ADDRESS,
                        VALID_TAGS, VALID_TASKS);
    ...
    @Test
    public void toModelType_nullRepoUrl_throwsIllegalValueException() {
    ...
    public void toModelType_invalidAddress_throwsIllegalValueException() {
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_NAME, VALID_PHONE, VALID_REPOURL, INVALID_ADDRESS,
                        VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_nullAddress_throwsIllegalValueException() {
        JsonAdaptedProject project = new JsonAdaptedProject(VALID_NAME, VALID_PHONE, VALID_REPOURL, null,
                VALID_TAGS, VALID_TASKS);
    ...
    public void toModelType_invalidTags_throwsIllegalValueException() {
        ...
        JsonAdaptedProject project =
                new JsonAdaptedProject(VALID_NAME, VALID_PHONE, VALID_REPOURL, VALID_ADDRESS,
