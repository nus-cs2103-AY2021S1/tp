...
public class ClearCommandTest {
    ...
    public void execute_nonEmptyAddressBook_success() {
        Model model = new ModelManager(getTypicalAddressBook(), new UserPrefs(), getTypicalBidderAddressBook(),
                getTypicalSellerAddressBook(), new BidBook());
        Model expectedModel = new ModelManager(getTypicalAddressBook(), new UserPrefs(), getTypicalBidderAddressBook(),
                getTypicalSellerAddressBook(), new BidBook());
