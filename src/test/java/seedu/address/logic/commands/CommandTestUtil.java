...
public class CommandTestUtil {
    ...
    public static final String VALID_PROFILE_PICTURE_AMY = "docs/images/stock_picture.png";
    public static final String VALID_PROFILE_PICTURE_BOB = "docs/images/stock_picture.png";
    ...
    public static final String INVALID_PROFILE_PICTURE_AMY = "docs/images/nosuchpictureexists.png";
    ...
    static {
        DESC_AMY = new EditPatientDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withTags(VALID_TAG_FRIEND).withProfilePicture(VALID_PROFILE_PICTURE_AMY).build();
        DESC_BOB = new EditPatientDescriptorBuilder().withName(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_BOB).withAddress(VALID_ADDRESS_BOB)
                .withTags(VALID_TAG_HUSBAND, VALID_TAG_FRIEND).withProfilePicture(VALID_PROFILE_PICTURE_BOB).build();
    }
