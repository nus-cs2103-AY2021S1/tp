...
public class CommandTestUtil {
    ...
    public static final String VALID_ALLERGY_BOB = "sulfa";
    ...
    public static final String ALLERGY_DESC_BOB = " " + PREFIX_ALLERGY + VALID_ALLERGY_AMY;
    ...
    static {
        DESC_AMY = new EditPatientDescriptorBuilder().withName(VALID_NAME_AMY)
                ...
                .withProfilePicture(VALID_PROFILE_PICTURE_AMY).build();
