...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditTaskDescriptorBuilder().withTitle(VALID_TITLE_AMY)
                .withDateTime(VALID_DATE_TIME_AMY).withDescription(VALID_DESCRIPTION_AMY).withAddress(VALID_ADDRESS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditTaskDescriptorBuilder().withTitle(VALID_TITLE_BOB)
                .withDateTime(VALID_DATE_TIME_BOB).withDescription(VALID_DESCRIPTION_BOB).withAddress(VALID_ADDRESS_BOB)
