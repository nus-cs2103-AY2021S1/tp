...
public class CommandTestUtil {
    ...
    public static final String VALID_TYPE_AMY = "Block 312, Amy Street 1";
    public static final String VALID_TYPE_BOB = "Block 123, Bobby Street 3";
    ...
    static {
        DESC_AMY = new EditTaskDescriptorBuilder().withTitle(VALID_TITLE_AMY)
                .withPhone(VALID_PHONE_AMY).withDescription(VALID_DESCRIPTION_AMY).withType(VALID_TYPE_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditTaskDescriptorBuilder().withTitle(VALID_TITLE_BOB)
                .withPhone(VALID_PHONE_BOB).withDescription(VALID_DESCRIPTION_BOB).withType(VALID_TYPE_BOB)
