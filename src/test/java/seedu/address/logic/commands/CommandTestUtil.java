...
public class CommandTestUtil {
    ...
    static {
        DESC_AMY = new EditPersonDescriptorBuilder().withTitle(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_AMY).withStatus(VALID_STATUS_AMY)
                .withTags(VALID_TAG_FRIEND).build();
        DESC_BOB = new EditPersonDescriptorBuilder().withTitle(VALID_NAME_BOB)
                .withPhone(VALID_PHONE_BOB).withStatus(VALID_STATUS_BOB)
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        final String[] splitName = person.getTitle().alphaNum.split("\\s+");
