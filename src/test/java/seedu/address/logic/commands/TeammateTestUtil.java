...
public class TeammateTestUtil {
    ...
    public static final String TEAMMATE_GIT_USERNAME_DESC_A = " " + PREFIX_TEAMMATE_GIT_USERNAME
        + VALID_TEAMMATE_GIT_USERNAME_A;
    public static final String TEAMMATE_GIT_USERNAME_DESC_B = " " + PREFIX_TEAMMATE_GIT_USERNAME
        + VALID_TEAMMATE_GIT_USERNAME_B;
    public static final String TEAMMATE_GIT_USERNAME_DESC_C = " " + PREFIX_TEAMMATE_GIT_USERNAME
        + VALID_TEAMMATE_GIT_USERNAME_C;

    public static final String TEAMMATE_PHONE_DESC_A = " " + PREFIX_TEAMMATE_PHONE + VALID_TEAMMATE_PHONE_A;
    public static final String TEAMMATE_PHONE_DESC_B = " " + PREFIX_TEAMMATE_PHONE + VALID_TEAMMATE_PHONE_B;
    public static final String TEAMMATE_PHONE_DESC_C = " " + PREFIX_TEAMMATE_PHONE + VALID_TEAMMATE_PHONE_C;

    public static final String TEAMMATE_EMAIL_DESC_A = " " + PREFIX_TEAMMATE_EMAIL + VALID_TEAMMATE_EMAIL_A;
    public static final String TEAMMATE_EMAIL_DESC_B = " " + PREFIX_TEAMMATE_EMAIL + VALID_TEAMMATE_EMAIL_B;
    public static final String TEAMMATE_EMAIL_DESC_C = " " + PREFIX_TEAMMATE_EMAIL + VALID_TEAMMATE_EMAIL_C;

    public static final String TEAMMATE_ADDRESS_DESC_A = " " + PREFIX_TEAMMATE_ADDRESS + VALID_TEAMMATE_ADDRESS_A;
