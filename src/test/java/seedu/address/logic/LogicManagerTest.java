...
import static seedu.address.logic.commands.CommandTestUtil.MODULE_DESC_ALEX;
...
public class LogicManagerTest {
    ...
    public void execute_commandExecutionError_throwsCommandException() {
        String deleteCommand = "deleteMod 9";
    ...
    public void execute_validCommand_success() throws Exception {
        ...
        assertCommandSuccess(listCommand, ListModuleCommand.MESSAGE_VIEWING_MODULES_SUCCESS, model);
    }
    ...
    public void execute_storageThrowsIoException_throwsCommandException() {
        ...
        String addModuleCommand = AddModuleCommand.COMMAND_WORD + MODULE_DESC_ALEX;
        Module expectedModule = new ModuleBuilder(CS2103T).build();
