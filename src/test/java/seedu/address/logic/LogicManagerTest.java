...
public class LogicManagerTest {
    ...
    @BeforeEach
    public void setUp() {
        JsonModuleStorage moduleListStorage =
                new JsonModuleStorage(temporaryFolder.resolve("addressBook.json"));
        JsonUserPrefsStorage userPrefsStorage = new JsonUserPrefsStorage(temporaryFolder.resolve("userPrefs.json"));
        StorageManager storage = new StorageManager(moduleListStorage, userPrefsStorage);
