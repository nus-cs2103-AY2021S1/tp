...
import seedu.address.storage.JsonOrderManagerStorage;
...
public class LogicManagerTest {
    ...
    public void setUp() {
        ...
        JsonOrderManagerStorage orderManagerStorage = new JsonOrderManagerStorage(temporaryFolder.resolve("presets.json"));
