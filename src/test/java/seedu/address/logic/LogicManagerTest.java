...
import seedu.address.storage.JsonFlashcardBookStorage;
...
public class LogicManagerTest {
    ...
    public void setUp() {
        JsonFlashcardBookStorage addressBookStorage =
                new JsonFlashcardBookStorage(temporaryFolder.resolve("addressBook.json"));
    ...
    public void execute_invalidCommandFormat_throwsParseException() {
        ...
        assertParseException(invalidCommand, MESSAGE_UNKNOWN_COMMAND + "\nMaybe you have used commands from Quiz "
            + "or Performance interfaces, which are not allowed in Flashcard interface.\n"
