...
public class EditEventParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        EditEventDescriptor descriptor = new EditEventDescriptorBuilder().withName(VALID_EVENT_NAME_1)
    ...
    public void parse_onlyDateSpecified_success() {
        EditEventDescriptor descriptor = new EditEventDescriptorBuilder().withDate(VALID_EVENT_DATE_1).build();
        EditEventCommand expectedCommand = new EditEventCommand(Index.fromOneBased(1), descriptor);
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        EditEventDescriptor descriptor = new EditEventDescriptorBuilder().withName(VALID_EVENT_NAME_2)
                .build();
        EditEventCommand expectedCommand = new EditEventCommand(Index.fromOneBased(1), descriptor);
