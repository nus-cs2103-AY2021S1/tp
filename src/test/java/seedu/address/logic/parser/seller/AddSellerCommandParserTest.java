...
public class AddSellerCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Seller expectedSeller = new SellerBuilder(BOB).build();
        ...
        Seller expectedSellerMultipleTags = new SellerBuilder(BOB).build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB,
                new AddSellerCommand(expectedSellerMultipleTags));
    }

    @Test
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Seller expectedSeller = new SellerBuilder(AMY).build();
