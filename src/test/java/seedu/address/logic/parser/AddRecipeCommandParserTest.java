...
public class AddRecipeCommandParserTest {
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + INGREDIENT_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing ingredients prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_INGREDIENT_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB,
                expectedMessage);
        ...
        assertParseFailure(parser, VALID_NAME_BOB + VALID_INGREDIENT_BOB + VALID_EMAIL_BOB + VALID_ADDRESS_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + INGREDIENT_DESC_BOB + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Name.MESSAGE_CONSTRAINTS);

        // invalid ingredients
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_INGREDIENT_DESC + EMAIL_DESC_BOB + ADDRESS_DESC_BOB
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + INGREDIENT_DESC_BOB + EMAIL_DESC_BOB + INVALID_ADDRESS_DESC,
                Name.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + INGREDIENT_DESC_BOB + EMAIL_DESC_BOB
