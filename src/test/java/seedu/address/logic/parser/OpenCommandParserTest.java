...
public class OpenCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + NAME_DESC_CS2103,
                new OpenCommand(expectedTag.getTagName()));

        // multiple names - last name accepted
        assertParseSuccess(parser, NAME_DESC_CS2101 + NAME_DESC_CS2103,
                new OpenCommand(expectedTag.getTagName()));
    }
    ...
    public void parse_invalidValue_failure() {
        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_CS2101,
                String.format(MESSAGE_INVALID_COMMAND_FORMAT, OpenCommand.MESSAGE_USAGE));
    }
