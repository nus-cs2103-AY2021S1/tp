...
public class ScheduleCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, " mode/weekly date/05/11/2020",
    ...
    public void parse_compulsoryFieldMissing_failure() {
        // date missing
        assertParseFailure(parser, " mode/weekly", String.format(MESSAGE_INVALID_COMMAND_FORMAT,
        ...
        // mode missing
        assertParseFailure(parser, " date/2020-11-05", String.format(MESSAGE_INVALID_COMMAND_FORMAT,
                ScheduleViewCommand.MESSAGE_USAGE));
    ...
    public void parse_invalidValue_failure() {
        // invalid mode
        assertParseFailure(parser, " mode/123 date/05/11/2020",
                ScheduleViewCommand.MESSAGE_INVALID_VIEW_MODE);

        //invalid date
        assertParseFailure(parser, " mode/daily date/1234",
