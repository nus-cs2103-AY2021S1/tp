 ...
 */
public class DeleteBidderCommandParserTest {

    private DeleteBidderCommandParser parser = new DeleteBidderCommandParser();

    @Test
    public void parse_validArgs_returnsDeleteCommand() {
        assertParseSuccess(parser, "1", new DeleteBidderCommand(INDEX_FIRST_PERSON));
    }
