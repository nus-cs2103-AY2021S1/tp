...
//        assertParseSuccess(parser, "delete 1/c expense", new DeleteCommand(INDEX_FIRST_PERSON, expense));
//    }
//    @Test
//    public void parse_validRevenue_returnsDeleteCommand() {
//        assertParseSuccess(parser, "delete 1/c revenue", new DeleteCommand(INDEX_FIRST_PERSON, revenue));
//    }
//
////    @Test
