...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_A
                + REPOURL_DESC_B + ADDRESS_DESC_BOB + TAG_DESC_FRIEND
                + TASK_DESC_DG, new AddCommand(expectedProject));

        // multiple addresses - last address accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_B
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_B
                ...
                + TASK_DESC_DG, new AddCommand(expectedProjectMultipleTags));

        // multiple tasks - all accepted
        Project expectedProjectMultipleTasks = new ProjectBuilder(BOB)
                .withTasks(VALID_TASK_DG, VALID_TASK_MODEL).build();
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_B
                        + ADDRESS_DESC_BOB + TAG_DESC_FRIEND + TAG_DESC_HUSBAND
                        + TASK_DESC_DG + TASK_DESC_MODEL, new AddCommand(expectedProjectMultipleTasks));
    }
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_AMY + PHONE_DESC_AMY + REPOURL_DESC_A
                        + ADDRESS_DESC_AMY + TASK_DESC_DG + TASK_DESC_MODEL,
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, VALID_NAME_BOB + PHONE_DESC_BOB + REPOURL_DESC_B + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, NAME_DESC_BOB + VALID_PHONE_BOB + REPOURL_DESC_B + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing email prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + VALID_REPOURL_B + ADDRESS_DESC_BOB,
                expectedMessage);

        // missing address prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_B + VALID_ADDRESS_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, VALID_NAME_BOB + VALID_PHONE_BOB + VALID_REPOURL_B + VALID_ADDRESS_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        // invalid name
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + REPOURL_DESC_B
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, ProjectName.MESSAGE_CONSTRAINTS);

        // invalid phone
        assertParseFailure(parser, NAME_DESC_BOB + INVALID_PHONE_DESC + REPOURL_DESC_B
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid email
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + INVALID_REPOURL_DESC
                + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, RepoUrl.MESSAGE_CONSTRAINTS);

        // invalid address
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + REPOURL_DESC_B
        ...
        assertParseFailure(parser, INVALID_NAME_DESC + PHONE_DESC_BOB + REPOURL_DESC_B
                        + INVALID_ADDRESS_DESC, ProjectName.MESSAGE_CONSTRAINTS);

        // non-empty preamble
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + NAME_DESC_BOB + PHONE_DESC_BOB
                        + REPOURL_DESC_B + ADDRESS_DESC_BOB + TAG_DESC_HUSBAND + TAG_DESC_FRIEND,
