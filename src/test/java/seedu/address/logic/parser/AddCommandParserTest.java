...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + TYPE_CASE + NAME_DESC_BOB
                + PHONE_DESC_BOB + STATUS_DESC_BOB + TAG_DESC_FRIEND,
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, TYPE_CASE + NAME_DESC_AMY + PHONE_DESC_AMY,
                new AddCommand(expectedPerson));
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        // missing name prefix
        assertParseFailure(parser, TYPE_CASE + VALID_NAME_BOB + PHONE_DESC_BOB,
                expectedMessage);

        // missing phone prefix
        assertParseFailure(parser, TYPE_CASE + NAME_DESC_BOB + VALID_PHONE_BOB,
                expectedMessage);

        // all prefixes missing
        assertParseFailure(parser, TYPE_CASE + VALID_NAME_BOB + VALID_PHONE_BOB,
                expectedMessage);
    }
    ...
    public void parse_invalidValue_failure() {
        ...
        // invalid phone
        assertParseFailure(parser, TYPE_CASE + NAME_DESC_BOB + INVALID_PHONE_DESC
                + TAG_DESC_HUSBAND + TAG_DESC_FRIEND, Phone.MESSAGE_CONSTRAINTS);

        // invalid status
        assertParseFailure(parser, TYPE_CASE + NAME_DESC_BOB + PHONE_DESC_BOB
