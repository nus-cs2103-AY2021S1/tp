...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Tag expectedPerson = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Tag expectedPersonMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Tag expectedPerson = new PersonBuilder(AMY).withTags().build();
