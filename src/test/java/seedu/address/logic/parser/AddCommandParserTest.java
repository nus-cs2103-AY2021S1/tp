...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        Log expectedLog = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND).build();
        ...
        Log expectedLogMultipleTags = new PersonBuilder(BOB).withTags(VALID_TAG_FRIEND, VALID_TAG_HUSBAND)
                .build();
    ...
    public void parse_optionalFieldsMissing_success() {
        // zero tags
        Log expectedLog = new PersonBuilder(AMY).withTags().build();
