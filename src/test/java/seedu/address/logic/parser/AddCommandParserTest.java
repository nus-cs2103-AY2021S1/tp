...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_AMY + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB
                + PAYMENT_DESC_BOB, new AddCommand(expectedStudent));

        //multiple times - last time accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_AMY + TIME_DESC_BOB + FEE_DESC_BOB
                + PAYMENT_DESC_BOB, new AddCommand(expectedStudent));

        //multiple fees - last fee accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_AMY + FEE_DESC_BOB
                + PAYMENT_DESC_BOB, new AddCommand(expectedStudent));

        //multiple payment dates - last date accepted
        assertParseSuccess(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB
                + PAYMENT_DESC_AMY + PAYMENT_DESC_BOB, new AddCommand(expectedStudent));
    }
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB
                + PAYMENT_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + YEAR_DESC_BOB
                + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB + PAYMENT_DESC_BOB, expectedMessage);
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB + PAYMENT_DESC_BOB, expectedMessage);

        //missing time prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + FEE_DESC_BOB + PAYMENT_DESC_BOB, expectedMessage);

        //missing fee prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_BOB + PAYMENT_DESC_BOB, expectedMessage);

        //missing payment date prefix
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB
                + YEAR_DESC_BOB + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB, expectedMessage);
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + YEAR_DESC_BOB
                + INVALID_VENUE_DESC + TIME_DESC_BOB + FEE_DESC_BOB + PAYMENT_DESC_BOB,
                ClassVenue.MESSAGE_CONSTRAINTS);

        //invalid time
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + YEAR_DESC_BOB
                        + VENUE_DESC_BOB + INVALID_TIME_DESC + FEE_DESC_BOB + PAYMENT_DESC_BOB,
                ClassTime.MESSAGE_CONSTRAINTS);

        //invalid fee
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + YEAR_DESC_BOB
                        + VENUE_DESC_BOB + TIME_DESC_BOB + INVALID_FEE_DESC + PAYMENT_DESC_BOB,
                Fee.MESSAGE_CONSTRAINTS);

        //invalid payment date
        assertParseFailure(parser, NAME_DESC_BOB + PHONE_DESC_BOB + SCHOOL_DESC_BOB + YEAR_DESC_BOB
                        + VENUE_DESC_BOB + TIME_DESC_BOB + FEE_DESC_BOB + INVALID_PAYMENT_DESC,
