...
public class EditCommandParserTest {
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_NAME_DESC + ADDRESS_DESC_BOB
                + NAME_DESC_BOB;
        descriptor = new EditPersonDescriptorBuilder().withName(VALID_NAME_BOB).withEmail(VALID_EMAIL_BOB)
