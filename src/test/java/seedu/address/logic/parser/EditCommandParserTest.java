...
public class EditCommandParserTest {
    ...
    private static final String CLIENTSOURCE_EMPTY = " " + PREFIX_CLIENTSOURCE;
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        String userInput = targetIndex.getOneBased() + PHONE_DESC_BOB + CLIENTSOURCE_DESC_HUSBAND
                + EMAIL_DESC_AMY + ADDRESS_DESC_AMY + NAME_DESC_AMY + CLIENTSOURCE_DESC_FRIEND;
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        // clientSources
        userInput = targetIndex.getOneBased() + CLIENTSOURCE_DESC_FRIEND;
        descriptor = new EditPersonDescriptorBuilder().withClientSources(VALID_CLIENTSOURCE_FRIEND).build();
        expectedCommand = new EditCommand(targetIndex, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
    }
    ...
    @Test
    public void parse_resetClientSources_success() {
        Index targetIndex = INDEX_THIRD_PERSON;
        String userInput = targetIndex.getOneBased() + CLIENTSOURCE_EMPTY;

        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder().withClientSources().build();
        EditCommand expectedCommand = new EditCommand(targetIndex, descriptor);
