...
import static seedu.address.logic.commands.CommandTestUtil.NAME_DESC_OLD_CS2101;
...
public class RetagCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        String userInput = NAME_DESC_OLD_CS2101 + NAME_DESC_CS2103;
    ...
    public void parse_compulsoryFieldMissing_failure() {
        ...
        assertParseFailure(parser, VALID_NAME_CS2101 + NAME_DESC_CS2103,
                expectedMessage);

        // missing new tag name prefix
        assertParseFailure(parser, NAME_DESC_OLD_CS2101 + VALID_NAME_CS2103,
                expectedMessage);
    ...
    public void parse_invalidTagInput_failure() {
        ...
        assertParseFailure(parser, INVALID_OLD_TAG_DESC + NAME_DESC_CS2103,
