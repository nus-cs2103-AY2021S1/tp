...
class AddVisitCommandParserTest {
    ...
    void parse_validArgs_returnsAddVisitCommand() {
        ...
        assertParseSuccess(parser, "1", new AddVisitCommand(visitDate, TypicalIndexes.INDEX_FIRST_PATIENT));
        assertParseSuccess(parser, "2", new AddVisitCommand(visitDate, TypicalIndexes.INDEX_SECOND_PATIENT));
        assertParseSuccess(parser, "3", new AddVisitCommand(visitDate, TypicalIndexes.INDEX_THIRD_PATIENT));
    }
