...
public class RemindCommandParserTest {
    ...
    public void parse_validArgs_returnsRemindCommand() {
        assertParseSuccess(parser, "1", new RemindCommand(INDEX_FIRST_PERSON));
    }

    @Test
    public void parse_invalidArgs_throwsParseException() {
        assertParseFailure(parser, "a", String.format(MESSAGE_INVALID_COMMAND_FORMAT, RemindCommand.MESSAGE_USAGE));
    }
}
