...
public class UiPartTest {
    ...
    private static final String VALID_FILE_PATH = "UiPartTest/validFileWithoutFxRoot.fxml";
    private static final String VALID_FILE_WITH_FX_ROOT_PATH = "UiPartTest/validFileFxRoot.fxml";
