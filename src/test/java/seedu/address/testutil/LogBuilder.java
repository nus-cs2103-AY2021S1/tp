...
import seedu.address.model.log.*;
...
public class LogBuilder {
    ...
    public LogBuilder() {
        ...
        dateTime = LocalDateTime.of(DEFAULT_YEAR, DEFAULT_MONTH, DEFAULT_DAY, DEFAULT_HOUR, DEFAULT_MINUTE);
    ...
    public Log build() {
        return new Log(exercise, reps, comment);
    }
