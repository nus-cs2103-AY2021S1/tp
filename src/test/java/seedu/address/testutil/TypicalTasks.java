...
public class TypicalTasks {
    ...
    public static final String TASK_A_NAME = " " + PREFIX_TASK_NAME + " "
            + SampleDataUtil.getValidTask().get(0);
    public static final String TASK_B_NAME = " " + PREFIX_TASK_NAME + " "
            + SampleDataUtil.getTask1().get(0);
    public static final String TASK_A_PROGRESS = " " + PREFIX_TASK_PROGRESS + " "
            + SampleDataUtil.getValidTask().get(3);
    public static final String TASK_B_PROGRESS = " " + PREFIX_TASK_PROGRESS + " "
            + SampleDataUtil.getTask1().get(3);
    public static final String TASK_A_DEADLINE = " " + PREFIX_TASK_DEADLINE + " "
            + SampleDataUtil.getValidTask().get(2);
    public static final String TASK_B_DEADLINE = " " + PREFIX_TASK_DEADLINE + " "
