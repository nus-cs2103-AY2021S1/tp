...
public class TypicalModules {
    public static final Module CS2030 = new ModuleBuilder().withName("CS2030")
        .withZoomLink(new ModuleLesson("Lecture"), "https://nus-sg.zoom.us/CS2030").build();
    public static final Module CS2101 = new ModuleBuilder().withName("CS2101")
        .withZoomLink(new ModuleLesson("Lecture"), "https://nus-sg.zoom.us/CS2101").build();
    public static final Module CS2105 = new ModuleBuilder().withName("CS2105")
        .withZoomLink(new ModuleLesson("Lecture"), "https://nus-sg.zoom.us/CS2105").build();
    ...
    public static final Module MA1101R = new ModuleBuilder().withName("MA1101R")
        .withZoomLink(new ModuleLesson("Lecture"), "https://nus-sg.zoom.us/MA1101R").build();
