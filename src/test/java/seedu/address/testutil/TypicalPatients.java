...
public class TypicalPatients {
    ...
    public static final Patient ALICE = new PatientBuilder().withName("Alice Pauline")
            ...
            .withTags("friends").withProfilePicture("data/stock_picture.png").withColorTag("None").build();
    public static final Patient BENSON = new PatientBuilder().withName("Benson Meier")
            .withAddress("311, Clementi Ave 2, #02-25")
            .withEmail("johnd@example.com").withPhone("98765432")
            .withTags("owesMoney", "friends").withProfilePicture("data/stock_picture.png").withColorTag("None").build();
    public static final Patient CARL = new PatientBuilder().withName("Carl Kurz").withPhone("95352563")
            .withEmail("heinz@example.com").withAddress("wall street")
            .withProfilePicture("data/stock_picture.png").withColorTag("None").build();
