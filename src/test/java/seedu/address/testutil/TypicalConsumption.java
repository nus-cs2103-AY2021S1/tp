...
public class TypicalConsumption {
    // Recipe
    public static final Recipe ALICE_RECIPE = new RecipeBuilder().withName("Alice Pauline").withIngredient("94351253")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe BENSON_RECIPE = new RecipeBuilder().withName("Benson Meier").withIngredient("98765432")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe CARL_RECIPE = new RecipeBuilder().withName("Carl Kurz").withIngredient("95352563")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe DANIEL_RECIPE = new RecipeBuilder().withName("Daniel Meier").withIngredient("87652533")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe ELLE_RECIPE = new RecipeBuilder().withName("Elle Meyer").withIngredient("9482224")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe FIONA_RECIPE = new RecipeBuilder().withName("Fiona Kunz").withIngredient("9482427")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe GEORGE_RECIPE = new RecipeBuilder().withName("George Best").withIngredient("9482442")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();

    // Manually added
    public static final Recipe HOON_RECIPE = new RecipeBuilder().withName("Hoon Meier").withIngredient("8482424")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
    public static final Recipe IDA_RECIPE = new RecipeBuilder().withName("Ida Mueller").withIngredient("8482131")
            .withCalories(10).withInstruction("instruction").withRecipeImage("images/healthy1").withTags("healthy")
            .build();
