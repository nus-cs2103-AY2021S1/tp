...
public class TypicalIndexes {
    ...
    public static final Index INDEX_FIRST_BID = Index.fromOneBased(1);
    public static final Index INDEX_SECOND_BID = Index.fromOneBased(2);
    public static final Index INDEX_THIRD_BID = Index.fromOneBased(3);
}
