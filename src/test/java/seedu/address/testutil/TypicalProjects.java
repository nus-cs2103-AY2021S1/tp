...
public class TypicalProjects {
    ...
    public static final Project CARL = new ProjectBuilder().withName("Carl Kurz")
            .withDeadline("21-03-2020 00:00:00").withEmail("heinz@example.com").withAddress("wall street")
            .withTasks("Read info pack").build();
    public static final Project DANIEL = new ProjectBuilder().withName("Daniel Meier")
            .withDeadline("21-03-2020 00:00:00").withEmail("cornelia@example.com").withAddress("10th street")
    ...
    public static final Project FIONA = new ProjectBuilder().withName("Fiona Kunz")
            .withDeadline("21-03-2020 00:00:00").withEmail("lydia@example.com")
    ...
    // Manually added
    public static final Project HOON = new ProjectBuilder().withName("Hoon Meier").withDeadline("21-03-2020 00:00:00")
            .withEmail("stefan@example.com").withAddress("little india").build();
    public static final Project IDA = new ProjectBuilder().withName("Ida Mueller").withDeadline("21-03-2020 00:00:00")
            .withEmail("hans@example.com").withAddress("chicago ave").build();

    // Manually added - Project's details found in {@code CommandTestUtil}
    public static final Project AMY = new ProjectBuilder().withName(VALID_NAME_AMY).withDeadline(VALID_DEADLINE_A)
            .withEmail(VALID_EMAIL_AMY).withAddress(VALID_ADDRESS_AMY).withTags(VALID_TAG_FRIEND)
            .withTasks(VALID_TASK_DG, VALID_TASK_MODEL).build();
    public static final Project BOB = new ProjectBuilder().withName(VALID_NAME_BOB).withDeadline(VALID_DEADLINE_B)
