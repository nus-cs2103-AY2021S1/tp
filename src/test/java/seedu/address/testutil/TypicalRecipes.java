...
import static seedu.address.logic.commands.CommandTestUtil.VALID_INSTRUCTION_AMY;
...
public class TypicalRecipes {
    ...
    public static final Recipe AMY = new RecipeBuilder().withName(VALID_NAME_AMY)
           ...
           .withCalories(VALID_CALORIES_AMY).withInstruction(VALID_INSTRUCTION_AMY)
            .withRecipeImage(VALID_RECIPE_IMAGE_AMY).build();
