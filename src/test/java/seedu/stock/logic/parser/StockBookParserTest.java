...
import seedu.stock.testutil.PersonUtil;
...
public class StockBookParserTest {
    ...
    public void parseCommand_add() throws Exception {
        ...
        AddCommand command = (AddCommand) parser.parseCommand(PersonUtil.getAddCommand(stock));
    ...
    public void parseCommand_edit() throws Exception {
        Stock stock = new PersonBuilder().build();
        EditPersonDescriptor descriptor = new EditPersonDescriptorBuilder(stock).build();
