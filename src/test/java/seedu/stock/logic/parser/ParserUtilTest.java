...
import static seedu.stock.logic.parser.ParserUtil.MESSAGE_INVALID_INDEX;
...
public class ParserUtilTest {
    ...
    public void parseEmail_invalidValue_throwsParseException() {
        assertThrows(ParseException.class, () -> ParserUtil.parseSource(INVALID_EMAIL));
    }

    @Test
    public void parseEmail_validValueWithoutWhitespace_returnsEmail() throws Exception {
        Source expectedSource = new Source(VALID_EMAIL);
        assertEquals(expectedSource, ParserUtil.parseSource(VALID_EMAIL));
    }
    ...
    public void parseEmail_validValueWithWhitespace_returnsTrimmedEmail() throws Exception {
        ...
        Source expectedSource = new Source(VALID_EMAIL);
        assertEquals(expectedSource, ParserUtil.parseSource(emailWithWhitespace));
    }
