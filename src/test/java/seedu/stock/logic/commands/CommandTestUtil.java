...
public class CommandTestUtil {
    ...
    public static final String PHONE_DESC_AMY = " " + PREFIX_SOURCE + VALID_PHONE_AMY;
    public static final String PHONE_DESC_BOB = " " + PREFIX_SOURCE + VALID_PHONE_BOB;
    public static final String EMAIL_DESC_AMY = " " + PREFIX_QUANTITY + VALID_EMAIL_AMY;
    public static final String EMAIL_DESC_BOB = " " + PREFIX_QUANTITY + VALID_EMAIL_BOB;
    ...
    public static final String INVALID_PHONE_DESC = " " + PREFIX_SOURCE + "911a"; // 'a' not allowed in phones
    public static final String INVALID_EMAIL_DESC = " " + PREFIX_QUANTITY + "bob!yahoo"; // missing '@' symbol
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        assertTrue(targetIndex.getZeroBased() < model.getFilteredStockList().size());

        Stock stock = model.getFilteredStockList().get(targetIndex.getZeroBased());
        final String[] splitName = stock.getName().fullName.split("\\s+");
