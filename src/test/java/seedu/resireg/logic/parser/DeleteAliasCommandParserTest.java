...
public class DeleteAliasCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + COMMAND_DESC_ROOMS_RO
            + ALIAS_DESC_ROOMS_RO, new DeleteAliasCommand(expectedAlias));
    ...
    public void parse_invalidValue_failure() {
        ...
        assertParseFailure(parser, INVALID_COMMAND_DESC + ALIAS_DESC_ROOMS_RO,
            CommandWord.MESSAGE_CONSTRAINTS);
        ...
        assertParseFailure(parser, PREAMBLE_NON_EMPTY + COMMAND_DESC_ROOMS_RO + ALIAS_DESC_ROOMS_RO,
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, DeleteAliasCommand.HELP.getFullMessage()));
    }
}
