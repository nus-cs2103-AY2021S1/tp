...
public class AddDocumentCommandParserTest {
    ...
    public static final String PREFIX_NAME = " " + CliSyntax.PREFIX_NAME.getPrefix();
    public static final String VALID_NAME = "I am a valid name";
    public static final String INVALID_NAME = "| am |nval|d name";
    public static final String PREFIX_REFERENCE = " " + CliSyntax.PREFIX_REFERENCE.getPrefix();
    public static final String VALID_REFERENCE = "test1.txt";
    ...
    public void parse_invalidArguments_throwsParseException() {
        // invalid name
        assertThrows(ParseException.class, () -> parser.parse(PREFIX_NAME + INVALID_NAME
                + PREFIX_REFERENCE + VALID_REFERENCE));
        assertParseFailure(parser, PREFIX_NAME + INVALID_NAME
                + PREFIX_REFERENCE + VALID_REFERENCE, Name.MESSAGE_CONSTRAINTS);

        // invalid reference
        assertThrows(ParseException.class, () -> parser.parse(PREFIX_NAME + VALID_NAME
                + PREFIX_REFERENCE + INVALID_REFERENCE));
        assertParseFailure(parser, PREFIX_NAME + VALID_NAME
                        + PREFIX_REFERENCE + INVALID_REFERENCE, Reference.MESSAGE_CONSTRAINTS);
    }
