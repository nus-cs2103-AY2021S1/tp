...
import static seedu.taskmaster.logic.commands.CommandTestUtil.INVALID_PHONE_DESC;
...
import static seedu.taskmaster.logic.commands.CommandTestUtil.PHONE_DESC_BOB;
...
import static seedu.taskmaster.logic.commands.CommandTestUtil.VALID_PHONE_AMY;
...
public class EditCommandParserTest {
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditStudentDescriptor descriptor = new EditStudentDescriptorBuilder().withName(VALID_NAME_AMY)
                .withPhone(VALID_PHONE_BOB).withEmail(VALID_EMAIL_AMY).withAddress(VALID_NUSNETID_AMY)
    ...
    public void parse_multipleRepeatedFields_acceptsLast() {
        Index targetIndex = INDEX_FIRST_STUDENT;
        String userInput = targetIndex.getOneBased() + PHONE_DESC_AMY + NUSNETID_DESC_AMY + EMAIL_DESC_AMY
    ...
    public void parse_invalidValueFollowedByValidValue_success() {
        ...
        userInput = targetIndex.getOneBased() + EMAIL_DESC_BOB + INVALID_PHONE_DESC + NUSNETID_DESC_BOB
                + PHONE_DESC_BOB;
