...
class JsonAdaptedInventoryRecordTest {
    ...
    @Test
    void toModelType_validDetails_returnsInventoryRecord() throws Exception {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(ITEM_NAME_3, QUANTITY_2, COST_1, DATE_TIME_B, ID_B);
        assertEquals(new InventoryRecord(ITEM_NAME_3, QUANTITY_2, COST_1, DATE_TIME_B, ID_B),
            testInventoryRecord.toModelType());
    }


    @Test
    void toModelType_edgeCost_returnsInventoryRecord() throws Exception {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(ITEM_NAME_1, QUANTITY_1, EDGE_COST, DATE_TIME_A, ID_A);
        assertEquals(new InventoryRecord(ITEM_NAME_1, QUANTITY_1, EDGE_COST, DATE_TIME_A, ID_A),
            testInventoryRecord.toModelType());
    }


    @Test
    void toModelType_edgeQuantity_returnsInventoryRecord() throws Exception {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(ITEM_NAME_2, EDGE_QUANTITY, COST_2, DATE_TIME_B, ID_B);
        assertEquals(new InventoryRecord(ITEM_NAME_2, EDGE_QUANTITY, COST_2, DATE_TIME_B, ID_B),
            testInventoryRecord.toModelType());
    }
    ...
    void toModelType_invalidName_throwsIllegalValueException() {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(null, QUANTITY_1, EDGE_COST, DATE_TIME_A, ID_A);
    ...
    void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(ITEM_NAME_2, EDGE_QUANTITY, COST_2, null, ID_B);
    ...
    void toModelType_invalidCost_throwsIllegalValueException() {
        JsonAdaptedInventoryRecord testInventoryRecord =
            new JsonAdaptedInventoryRecord(ITEM_NAME_3, QUANTITY_2, -15.7, DATE_TIME_B, ID_B);
