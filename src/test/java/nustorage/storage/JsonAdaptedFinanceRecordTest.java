...
class JsonAdaptedFinanceRecordTest {
    ...
    void toModelType_edgeId_returnsFinanceRecord() throws Exception {
        ...
        assertEquals(new FinanceRecord(EDGE_ID, AMOUNT_A, DATE_TIME_D, HAS_INVENTORY_B),
            testFinanceRecord.toModelType());
    }
    ...
    void toModelType_edgeAmount_returnsFinanceRecord() throws Exception {
        ...
        assertEquals(new FinanceRecord(ID_A, EDGE_AMOUNT, DATE_TIME_D, HAS_INVENTORY_B),
            testFinanceRecord.toModelType());
    }
