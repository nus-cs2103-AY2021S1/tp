...
class JsonAdaptedFinanceRecordTest {
    ...
    void toModelType_validDetails1_returnsFinanceRecord() throws Exception {
        JsonAdaptedFinanceRecord testFinanceRecord = new JsonAdaptedFinanceRecord(AMOUNT_1, DATE_TIME_1);
        assertEquals(new FinanceRecord(AMOUNT_1, DATE_TIME_1), testFinanceRecord.toModelType());
    }


    @Test
    void toModelType_validDetails2_returnsFinanceRecord() throws Exception {
        JsonAdaptedFinanceRecord testFinanceRecord = new JsonAdaptedFinanceRecord(AMOUNT_2, DATE_TIME_2);
        assertEquals(new FinanceRecord(AMOUNT_2, DATE_TIME_2), testFinanceRecord.toModelType());
    }


    @Test
    void toModelType_validDetails3_returnsFinanceRecord() throws Exception {
        JsonAdaptedFinanceRecord testFinanceRecord = new JsonAdaptedFinanceRecord(AMOUNT_3, DATE_TIME_3);
        assertEquals(new FinanceRecord(AMOUNT_3, DATE_TIME_3), testFinanceRecord.toModelType());
    }


    @Test
    void toModelType_invalidAmount_throwsIllegalValueException() {
        JsonAdaptedFinanceRecord testFinanceRecord = new JsonAdaptedFinanceRecord(-1, DATE_TIME_4);
    ...
    void toModelType_invalidDate_throwsIllegalValueException() {
        JsonAdaptedFinanceRecord testFinanceRecord = new JsonAdaptedFinanceRecord(AMOUNT_2, null);
